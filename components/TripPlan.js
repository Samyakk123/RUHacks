...
export default function TripPlan({navigation}) {
  return (
    ...
    source={require('./../images/TripRoulette.svg')}>

      <TouchableHighlight style={{right: 147, top: 280}} onPress= { () => navigation.navigate("loginPage")}>
        <Image style={{ width: 76, height: 76 }} source={require('./../images/next2.png')}></Image>    
      </TouchableHighlight >


      <TouchableHighlight style={{right: 0, top: 210}} onPress= { () => navigation.navigate("friend")}>
        <Image style={{ width: 150, height: 70 }} source={require('./../images/planButton.png')}></Image>    
      </TouchableHighlight >


      <TouchableHighlight style={{left: 147, top: 135}} onPress= { () => navigation.navigate("trip2")}>
