...
export default function TripPlan2({navigation}) {
  return (
    <View style={styles.container}>

    <ImageBackground style={{ alignItems: 'center', paddingBottom: 25, justifyContent: "center", width: 414, height: 896 }} 
    source={require('./../images/TripRoulette2.svg')}>

      <TouchableHighlight style={{right: 147, top: 248}} onPress= { () => navigation.navigate("trip")}>
        <Image style={{ width: 76, height: 76 }} source={require('./../images/next2.png')}></Image>    
      </TouchableHighlight >

      <TouchableHighlight style={{left: 147, top: 170}} onPress= { () => navigation.navigate("trip3")}>
